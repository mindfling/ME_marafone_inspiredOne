...
export const renderHeader = () => {
  ...
  <div class="container header__container">
    <a class="header__phone header__link" href="tel:89001231234" title="Office phone">8&nbsp;930&nbsp;490&nbsp;26&nbsp;20</a>
    <img class="header__logo" src="./assets/logo.svg" alt="Logo Inspired" />
    <div class="header__navigation">
      <ul class="header__nav-list">
        <li class="header__nav-item">
          <button class="header__link" title="Поиск товаров">
        ...
        <li class="header__nav-item">
          <a href="#" class="header__link" title="Корзина">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="header__nav-item">
          <a href="#" class="header__link" title="Избранное">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
